...
{
       0,   120,   120,   121,   125,   126,   130,   131,   132,   133,
     134,   135,   136,   140,   142,   144,   146,   148,   150,   152,
     154,   156,   163,   173,   180,   181,   182,   185,   195,   196,
     197,   200,   203,   207,   208,   212,   213,   221,   228,   235,
     236
};
#endif
...
{
  "$end", "error", "$undefined", "LABEL", "INTEGER", "KWD_INT",
  "KWD_WHILE", "KWD_IF", "KWD_RETURN", "'='", "'+'", "'-'", "'*'", "'/'",
  "';'", "'{'", "'}'", "'('", "')'", "'['", "']'", "','", "$accept",
  "program", "stmt_list", "stmt", "expr", "func_decl", "func_decl_arglist",
  "func_decl_arglist_arg", "func_call_arglist", "func_call_arglist_arg",
  "decl_stmt", "decl_list", "var_decl", "if_stmt", "while_stmt",
...
static const yytype_uint16 yytoknum[] =
{
      ...
      43,    45,    42,    47,    59,   123,   125,    40,    41,    91,
      93,    44
};
# endif
...
{
     -21,    39,   -21,     9,   -21,     4,    18,    42,   -17,    27,
     -21,    48,    18,     5,   -21,    43,    30,    58,     0,   -21,
      48,     0,   -21,    47,    50,   -21,   -21,    62,   -21,     0,
      74,     0,    64,   -21,    63,     0,     0,    25,    26,   -21,
      56,     0,     0,     0,     0,   -21,   -21,   -21,    25,   -21,
      67,    65,    -4,    84,    43,    60,    69,   -21,   -21,   -21,
      -2,    -2,   -21,   -21,   -21,    74,   -21,    70,   -21,    48,
      48,   -21,   -21,   -21,   -21
};
...
{
       2,     0,     1,     0,     3,     0,    24,     0,     0,    25,
      27,     0,    24,    20,    19,     0,     0,     0,    39,     6,
       0,     0,    23,     0,     0,     9,    10,     0,    26,     0,
      28,     0,    35,    32,    33,     0,     0,    40,     0,     4,
       0,     0,     0,     0,     0,     7,     8,    11,    18,    31,
       0,    29,     0,     0,     0,     0,     0,    12,     5,    17,
      13,    14,    15,    16,    22,    28,    21,     0,    34,     0,
       0,    30,    36,    38,    37
};
...
{
      39,    11,    37,    13,    14,    40,    41,    42,    43,    44,
      43,    44,     5,    48,    29,    52,    66,    21,    58,    55,
      56,     6,    30,     7,    31,    60,    61,    62,    63,    13,
      14,    15,    16,    17,    18,    41,    42,    43,    44,     2,
      19,    20,    57,    21,     3,    10,    32,    35,    12,    73,
      74,    13,    14,    15,    16,    17,    18,    41,    42,    43,
      44,    45,    19,    20,    46,    21,    41,    42,    43,    44,
      41,    42,    43,    44,    59,    36,    47,    49,    69,    41,
      42,    43,    44,    53,    54,    64,    65,    70,    67,    28,
      72,    68,     0,    71
};

static const yytype_int8 yycheck[] =
{
      20,    18,    18,     3,     4,    21,    10,    11,    12,    13,
      12,    13,     3,    29,     9,    31,    20,    17,    38,    35,
      36,    17,    17,     5,    19,    41,    42,    43,    44,     3,
       4,     5,     6,     7,     8,    10,    11,    12,    13,     0,
      14,    15,    16,    17,     5,     3,     3,    17,    21,    69,
      70,     3,     4,     5,     6,     7,     8,    10,    11,    12,
      13,    14,    14,    15,    14,    17,    10,    11,    12,    13,
      10,    11,    12,    13,    18,    17,    14,     3,    18,    10,
      11,    12,    13,    19,    21,    18,    21,    18,     4,    12,
      20,    54,    -1,    65
};
...
{
       0,    23,     0,     5,    27,     3,    17,     5,    28,    29,
       3,    18,    21,     3,     4,     5,     6,     7,     8,    14,
      15,    17,    25,    26,    32,    35,    36,    37,    28,     9,
      17,    19,     3,    33,    34,    17,    17,    26,    24,    25,
      26,    10,    11,    12,    13,    14,    14,    14,    26,     3,
      30,    31,    26,    19,    21,    26,    26,    16,    25,    18,
      26,    26,    26,    26,    18,    21,    20,     4,    33,    18,
      18,    30,    20,    25,    25
};
...
#line 121 "parser.y" /* yacc.c:1646  */
    { /* printf ("Returned assembly: %s\n", $2); */ generatedAssembly = createString(generatedAssembly, (yyvsp[0].sval)); }
#line 1360 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 126 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString((yyvsp[-1].sval), (yyvsp[0].sval)); }
#line 1366 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 130 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(""); }
...
#line 140 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(binOpVars((yyvsp[-2].sval), (yyvsp[0].sval)), createString("addi $1, $1, $2\n")); }
#line 1414 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 142 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(binOpVars((yyvsp[-2].sval), (yyvsp[0].sval)), createString("subi $1, $2, $1\n")); }
#line 1420 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 144 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(binOpVars((yyvsp[-2].sval), (yyvsp[0].sval)), createString("muli $1, $1, $2\n")); }
#line 1426 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 146 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(binOpVars((yyvsp[-2].sval), (yyvsp[0].sval)), createString("divi $1, $2, $1\n")); }
...
#line 150 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString(createString( (yyvsp[0].sval) ), createString(createString(createString("st $1, "), createString(getSymbolOffset((yyvsp[-2].sval)))), createString("($30)\n")));}
#line 1444 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 152 "parser.y" /* yacc.c:1646  */
    { /* andi $1, $1, 0 \nori $1, $1, const*/ (yyval.sval) = createString(createString(createString("andi $1, $1, 0 \nori $1, $1, "), createString((yyvsp[0].ival))), createString("\n")); }
#line 1450 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 154 "parser.y" /* yacc.c:1646  */
    { /* ld $1, offset($30) */ (yyval.sval) = createString(createString(createString("ld $1, "), createString(getSymbolOffset((yyvsp[0].sval)))), createString("($30)\n")); }
...
#line 156 "parser.y" /* yacc.c:1646  */
    { 
		char *ld = createString(createString(createString("ld $1, "), createString(getSymbolOffset((yyvsp[-3].sval)))), createString("($30)\n"));
		//Warning - do not nest array references as the $3 will get overwritten
		sprintf(strBuffer, "%smuli $3, $1, 4 \nsub $30, $30, $3 \n%saddi $30, $30, $3 \n", (yyvsp[-1].sval), ld);
	  	(yyval.sval) = createString(strBuffer, false); 
	}
...
#line 182 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString( (yyvsp[-2].sval), (yyvsp[0].sval) ); }
...
#line 200 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString("subi $29, $29, 4 \n"); }
...
#line 213 "parser.y" /* yacc.c:1646  */
    { 
	  		if ( (yyvsp[-1].ival) > 1024) yyerror("Array size is too large.");
	  		sprintf(strBuffer, "subi $29, $29, %d\n", 4*(yyvsp[-1].ival));
	  		(yyval.sval) = createString(strBuffer, false); 
	  		declSymbol((yyvsp[-3].sval), (yyvsp[-1].ival)); 
	  }
...
#line 221 "parser.y" /* yacc.c:1646  */
    { 
		...
		sprintf(strBuffer, "%sandi $2, $2, 0 \nbe $1, $2, %s \n%s \n%s:\n", (yyvsp[-2].sval), ifExit, (yyvsp[0].sval), ifExit);
		(yyval.sval) = createString(strBuffer, false);
	}
...
#line 228 "parser.y" /* yacc.c:1646  */
    {
		...
		sprintf(strBuffer, "%s: \n%sandi $2, $2, 0 \nbe $1, $2, %s \n%sj %s \n%s:\n", loopEntry, (yyvsp[-2].sval), loopExit, (yyvsp[0].sval), loopEntry, loopExit);
		(yyval.sval) = createString(strBuffer, false);
	}
...
#line 235 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString("ld $31, 4($29) \nld $4, 8($29) \nori $29, $30, 0 \nori $30, $4, 0\njr $31"); }
#line 1603 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 236 "parser.y" /* yacc.c:1646  */
    { (yyval.sval) = createString((yyvsp[0].sval), createString("ld $31, 4($29) \nld $4, 8($29) \nori $29, $30, 0 \nori $30, $4, 0\njr $31")); }
